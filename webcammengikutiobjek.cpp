...
int main( int argc, char** argv ){
	...
	cvCreateTrackbar("LowS", "Control", &iLowS, 255); //Saturation (0 - 255)
 	...
 	cvCreateTrackbar("HighV", "Control", &iHighV, 255);
		...
		putText(imgOriginal, "Klik", Point(5,10), FONT_HERSHEY_COMPLEX, 0.35, Scalar(0, 255, 0), 0.25, 8);
		putText(imgOriginal, "a : Mengikuti Objek", Point(5,20), FONT_HERSHEY_COMPLEX, 0.35, Scalar(0, 255, 0), 0.25, 8);
